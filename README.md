...
URL ```  https://api.bithank.com/currency/trade/market/buy```
示例
```
# Request
GET   https://api.bithank.com/currency/trade/market/buy
# Response
[{
        "txNo":15300629835086
        "result":3000
...
URL ```   https://api.bithank.com/currency/trade/market/sell```
示例
```
# Request
GET    https://api.bithank.com/currency/trade/market/sell
# Response
[{
...
URL ```https://api.bithank.com/currency/trade/buy```
示例
```
# Request
GET     https://api.bithank.com/currency/trade/buy
# Response
[{
...
URL ```    https://api.bithank.com/currency/trade/sell```
示例
```
# Request
GET     https://api.bithank.com/currency/trade/sell
# Response
[{
...
URL ```  https://api.bithank.com/currency/trade/findHistoryEntrust ```
示例
```
# Request
GET https://api.bithank.com/currency/trade/findHistoryEntrust
# Response
{
	"data":[{
...
URL ```https://api.bithank.com/currency/trade/findEntrust ```
示例
```
# Request
GET https://api.bithank.com/currency/trade/findEntrust
# Response
{
	"data":[{
	"createTimeString":2018-06-21 15:23:44
...
URL ```https://api.bithank.com/v1/market/tickers```
示例
```
# Request
GET   https://api.bithank.com/v1/market/tickers
# Response
{
    "date":1530884195825
    "ticker":{
...
URL ```https://api.bithank.com/v1/market/depth```
示例
```
# Request
GET   https://api.bithank.com/v1/market/depth
# Response
{
   "ask":[
...
URL ```https://api.bithank.com/currency/trade/cancel```
示例
```
# Request
GET   https://api.bithank.com/currency/trade/cancel
# Response
{
     "result":success
}
...
URL ```https://api.bithank.com/currency/trade/findOrder```
示例
```
# Request
GET   https://api.bithank.com/currency/trade/findOrder
# Response
{
     "result":success
     "data":{
...
URL ```https://api.bithank.com/member/getAccount```
示例
```
# Request
GET https://api.bithank.com/member/getAccount
# Response
[{  
     "blockedNum":0
