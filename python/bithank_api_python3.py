...
class bithank_api:
    ...
    def __api_call(self, path, params = ''):
        try:
            ...
            #url = 'https:/api.bithank.com/' + path + '?' + params
    ...
    def query_account(self):
        try:
            ...
            print(sys.stderr, 'bithank query_account exception,',ex)
            return None
    def buy_price(self,symbol,num,price):
        try:
            ...
            print(sys.stderr, 'bethink buy_price exception,', ex)
            return None
    def sell_price(self,symbol,num,price):
        try:
            ...
            print(sys.stderr, 'bithank buy_price exception,', ex)
            return None
...
if __name__ == '__main__':
    ...
    api = bithank_api(access_key, access_secret)
